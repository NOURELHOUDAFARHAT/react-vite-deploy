          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            <div className="relative mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
              <div className="drop-shadow-2">
                ...
                >
                  <Button size="notifi" onClick={() => openModal()}>
                    <svg
            ...
            <div className="mt-4">
              <h3 className="mb-1.5 text-2xl font-semibold text-black dark:text-white">
                ...
                {item.fullName ? `${item.fullName.charAt(0).toUpperCase()}${item.fullName.slice(1)}` : ''}
              </h3>
              <p className="font-medium"> {item.email}</p>
              <div className="mx-auto mt-4.5 mb-5.5 grid max-w-70 grid-cols-2 rounded-md bg-black border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-strokedark">
                <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-boxdark xsm:flex-row">
                ...
                <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-boxdark xsm:flex-row">
                  ...
                  <span className="text-sm text-white">Invitation</span>
                </div>
              </div>
              ...
              <div className="mx-auto max-w-180">
                ...
                <p className="mt-4.5">
                Breaking free in every time zone ⏳
                <br />

Harboring sunsets and heartthrobs in my chronicle 🌄
<br />
Escape with me, let's make it epic 👇
                </p>
              </div>
